...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT(
       ...
       _______,        __NOP__,  __NOP__,  KC_7,     KC_8,     KC_9,     __NOP__,  __NOP__,  __NOP__,  __NOP__,  KC_PSCR,  KC_SLCK,  KC_PAUS,  __NOP__,  KC_END, \
       _______,        __NOP__,  __NOP__,  KC_4,     KC_5,     KC_6,     __NOP__,  __NOP__,  __NOP__,  __NOP__,  __NOP__,  __NOP__,            KC_MPLY,  LSFT(KC_INS), \
       _______,        __NOP__,  __NOP__,  KC_1,     KC_2,     KC_3,     __NOP__,  __NOP__,  __NOP__,  __NOP__,  __NOP__,  __NOP__,            KC_VOLU,  __NOP__, \
