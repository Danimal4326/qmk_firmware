...
#define ISSI3733_LED_MAP { \
 ...
 { .id = 43,  .x = 10.031, .y = -1.5,   .adr = { .drv = 1, .cs = 6,  .swr = 11, .swg = 10, .swb = 12 }, .scan = 42 }, \
 { .id = 44,  .x = 11.25,  .y = -1.5,   .adr = { .drv = 1, .cs = 7,  .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 43 }, \
 { .id = 45,  .x = 0.469,  .y = -2.25,  .adr = { .drv = 2, .cs = 2,  .swr = 11, .swg = 10, .swb = 12 }, .scan = 44 }, \
 { .id = 46,  .x = 1.688,  .y = -2.25,  .adr = { .drv = 2, .cs = 9,  .swr = 5,  .swg = 4,  .swb = 6  }, .scan = 45 }, \
 { .id = 47,  .x = 2.438,  .y = -2.25,  .adr = { .drv = 2, .cs = 9,  .swr = 2,  .swg = 1,  .swb = 3  }, .scan = 46 }, \
 { .id = 48,  .x = 3.188,  .y = -2.25,  .adr = { .drv = 2, .cs = 9,  .swr = 11, .swg = 10, .swb = 12 }, .scan = 47 }, \
 { .id = 49,  .x = 3.938,  .y = -2.25,  .adr = { .drv = 2, .cs = 9,  .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 48 }, \
 { .id = 50,  .x = 4.688,  .y = -2.25,  .adr = { .drv = 2, .cs = 12, .swr = 11, .swg = 10, .swb = 12 }, .scan = 49 }, \
 { .id = 51,  .x = 5.438,  .y = -2.25,  .adr = { .drv = 2, .cs = 13, .swr = 11, .swg = 10, .swb = 12 }, .scan = 50 }, \
 { .id = 52,  .x = 6.188,  .y = -2.25,  .adr = { .drv = 1, .cs = 9,  .swr = 11, .swg = 10, .swb = 12 }, .scan = 51 }, \
 { .id = 53,  .x = 6.938,  .y = -2.25,  .adr = { .drv = 1, .cs = 10, .swr = 11, .swg = 10, .swb = 12 }, .scan = 52 }, \
 { .id = 54,  .x = 7.688,  .y = -2.25,  .adr = { .drv = 1, .cs = 10, .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 53 }, \
 { .id = 55,  .x = 8.438,  .y = -2.25,  .adr = { .drv = 1, .cs = 11, .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 54 }, \
 { .id = 56,  .x = 9.469,  .y = -2.25,  .adr = { .drv = 1, .cs = 11, .swr = 2,  .swg = 1,  .swb = 3  }, .scan = 55 }, \
 { .id = 57,  .x = 10.5,   .y = -2.25,  .adr = { .drv = 1, .cs = 11, .swr = 5,  .swg = 4,  .swb = 6  }, .scan = 56 }, \
 { .id = 58,  .x = 11.25,  .y = -2.25,  .adr = { .drv = 1, .cs = 7,  .swr = 11, .swg = 10, .swb = 12 }, .scan = 57 }, \
 { .id = 59,  .x = 0.094,  .y = -3,     .adr = { .drv = 2, .cs = 10, .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 58 }, \
 { .id = 60,  .x = 1.031,  .y = -3,     .adr = { .drv = 2, .cs = 10, .swr = 5,  .swg = 4,  .swb = 6  }, .scan = 59 }, \
 { .id = 61,  .x = 1.969,  .y = -3,     .adr = { .drv = 2, .cs = 10, .swr = 2,  .swg = 1,  .swb = 3  }, .scan = 60 }, \
 { .id = 62,  .x = 4.781,  .y = -3,     .adr = { .drv = 2, .cs = 12, .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 61 }, \
 { .id = 63,  .x = 7.594,  .y = -3,     .adr = { .drv = 1, .cs = 10, .swr = 5,  .swg = 4,  .swb = 6  }, .scan = 62 }, \
 { .id = 64,  .x = 8.531,  .y = -3,     .adr = { .drv = 1, .cs = 10, .swr = 2,  .swg = 1,  .swb = 3  }, .scan = 63 }, \
 { .id = 65,  .x = 9.75,   .y = -3,     .adr = { .drv = 1, .cs = 12, .swr = 2,  .swg = 1,  .swb = 3  }, .scan = 64 }, \
 { .id = 66,  .x = 10.5,   .y = -3,     .adr = { .drv = 1, .cs = 12, .swr = 8,  .swg = 7,  .swb = 9  }, .scan = 65 }, \
 { .id = 67,  .x = 11.25,  .y = -3,     .adr = { .drv = 1, .cs = 12, .swr = 5,  .swg = 4,  .swb = 6  }, .scan = 66 }, \
